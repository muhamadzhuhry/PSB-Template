    ...
    <nav id="navigation" class="navbar navbar-inverse navbar-fixed-top" role=navigation"">
        <div class="container">
            <div class="navbar-header">
                ...
                <a data-scroll href="#header" class="navbar-brand"><img src="img/logo-pis.jpg" class="img-circle" alt="Logo"></a>
        ...
        <div class="navbar-collapse collapse navbar-primary" role="navigation">
            <ul class="nav navbar-nav navbar-left">
                <li class="active"><a href="index.html"><span class="fa fa-home" aria-hidden="true"></span> BERANDA</a></li>
                <li><a href="peserta.html"><span class="fa fa-address-card-o" aria-hidden="true"></span> PESERTA</a></li>
                <li><a href="pendaftaran.html"><span class="fa fa-pencil" aria-hidden="true"></span> PENDAFTARAN</a></li>
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-info-circle" aria-hidden="true"></span> INFORMASI <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="informasi-prosedur.html" target="_blank">Prosedur</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="informasi-jadwal.html" target="_blank">Jadwal</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="informasi-pengumuman.html" target="_blank">Pengumuman</a></li>
                        <li role="separator" class="divider"></li>
                    </ul>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="login.html"><span class="fa fa-key" aria-hidden="true"></span> LOGIN</a></li>
            </ul>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="jumbotron">
                    ...
                    <p>Selamat datang di website <a href="index.html" class="link-jumbotron" target="_blank"><b>Penerimaan Santri Baru (PSB) Online Pesantren Imam Syafi'i. </b></a>Sebelum melakukan pendaftaran, sebaiknya Anda menyimak prosedur pendaftaran santri baru di halaman <a href="index.html" class="link-jumbotron" target="_blank"><b> Prosedur Pendaftaran. </b></a></p>
                    <p>Pastikan juga anda mengetahui jadwal PSB di halaman Jadwal. Semua informasi terbaru mengenai PSB Online Pesantren Imam Syafi'i bisa Anda lihat di halaman <a href="index.html" class="link-jumbotron" target="_blank"><b> Pengumuman. </b></a></p>
                    <p>Anda juga dapat mengetahui data pendaftar di Pesantren Imam Syafi'i di halaman <a href="index.html" class="link-jumbotron" target="_blank"><b> Peserta. </b></a></p>
                    <p>Apabila anda sudah memahami prosedur opendaftaran, silahkan klik tombol <a href="index.html" class="link-jumbotron" target="_blank"><b> "Daftar" </b></a> di bawah ini.</p>
